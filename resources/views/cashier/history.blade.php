                        ...
                        <tbody>
                            ...
                            @foreach ($cashier as $index => $transactions)
                                <tr>
                                    ...
                                    <td>Rp.
                                        {{ number_format($transactions->sum('subtotal') * (1 - $transactions->first()->discount / 100), '0') }}
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            ...
                                            <a href="{{ route('cashier.reprint', $transactions->first()->code) }}"
                                                class="btn btn-sm btn-warning btn-sm" style="margin: 3px" target="_blank">
